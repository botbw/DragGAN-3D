...
if __name__ == "__main__":
    ...
    points_ori = [
        WorldPoint(torch.tensor((-0.09,0.04,-0.008), device=device)),
        WorldPoint(torch.tensor((0.09,0.04,-0.008), device=device)),
    ]

    points_target = [
        WorldPoint(torch.tensor((-0.09,-0.02,-0.008), device=device)),
        WorldPoint(torch.tensor((0.09,-0.03,-0.008), device=device)),
    ]
